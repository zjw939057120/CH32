...
__attribute__((__aligned__(4))) struct uart_data  uart_data_t;
/* UART2 */
__attribute__((__aligned__(4))) u8  UART2_RX_DMA_DataBuf[UART_RX_DMA_SIZE] = {0};
__attribute__((__aligned__(4))) u8  UART2_TX_DMA_DataBuf[UART_TX_BUF_NUM][ETH_RECEIVE_SIZE] = {0};
