 ...
 *ADC channel 2(PA2), which detects that the ADC conversion data on the channel of this 
 *rule group is 2000-3500 and triggers the simulation Watchdog interrupt.
 *
 */
